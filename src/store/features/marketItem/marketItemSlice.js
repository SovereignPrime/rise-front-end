  ...
  initialState: {
    marketItems: [
      ...
      },
      {
        ...
        prodPic: [prod2, prod1], //this was just `prodPic: prod2,` before I changed it into an array to test ProductDetails.js ' handling of slideshows.
        //http://localhost:3000/#/Dashboard/MarketPlace/ shows the alt tag for the image now
        Good: 14,
        Bad: 2,
        Date: "2022-05-22",
      },
